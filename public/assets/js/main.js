...
-----------------------------------*/
    ...
    function customizer() {
        var $cusHtml = `<div class=${
            ["/auth/register", "/auth/login"].includes(window.location.pathname)
                ? "d-none"
                : "customizer-wrapper"
        }>`;
        $cusHtml +=
        ...
        $cusHtml +=
            '<label class="adomx-switch primary toggle-dark"><input type="checkbox" checked> <i class="lever"></i> <span class="text">Dark Version</span></label>';
        $cusHtml +=
        ...
        $cusHtml +=
            '<div class="tab-pane fade show active" id="sidebar-setting">';
            ...
            toggleDARK.on("click", function () {
                ...
                if ($this.find('input[type="checkbox"]').prop("checked")) {
                    ...
                    $body.removeClass(function (index, className) {
                        return (
                            className.match(/\bheader-top-\S+/g) || []
                        ).join(" ");
                    });
                    $body.removeClass(function (index, className) {
                        return (
                            className.match(/\bside-header-\S+/g) || []
                        ).join(" ");
                    });
                } else if (
